// Roman (1987) constellation boundary table, B1875. Source: https://raw.githubusercontent.com/astropy/astropy/main/astropy/coordinates/data/constellation_data_roman87.dat
// (astropy's verbatim copy of VizieR catalog VI/42 "Identification of a Constellation From Position", Roman N.G. 1987, PASP 99, 695). Retrieved 2026-07-09.
// 357 rows. Row: [raLoHours, raHiHours, decLoDeg, abbr] in the B1875.0 frame. The FIRST matching row wins.
export const CONSTELLATION_BOUNDS: readonly (readonly [number, number, number, string])[] = [
...
// Abbreviation -> full IAU name, all 88 constellations.
